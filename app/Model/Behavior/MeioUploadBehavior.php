 ...
 */
	var $defaultOptions = array(
		...
		'maxSize' => 2097152, // 2MB
	//	'allowedMime' => array('image/jpeg', 'image/pjpeg', 'image/png', 'image/gif', 'image/bmp', 'image/x-icon', 'image/vnd.microsoft.icon','application/pdf', 'application/vnd.ms-word', 'application/vnd.ms-powerpoint', 'application/vnd.ms-excel','application/rtf', 'application/zip', 'application/excel'),
	    'allowedMime' => array('application/vnd.openxmlformats-officedocument.wordprocessingml.document','application/pdf', 'application/msword', 'application/mspowerpoint', 'application/excel', 'application/rtf', 'application/zip', 'application/msexcel'),
	
		'allowedExt' => array('.jpg', '.jpeg', '.png', '.gif', '.bmp', '.ico','.pdf', '.docx', '.ppt', '.xls','.rtf', '.zip', '.doc','xml','xlsx','xls'),
 ...
 */
	function __construct() {
		$messages = array(
			...
			'Empty' => array(
				'message' => __d('meio_upload', 'Seleccione una imagen.')
			),
			'UploadError' => array(
				'message' => __d('meio_upload', 'No se pudo subir la imagen.')
			),
			'MaxSize' => array(
				'message' => __d('meio_upload', 'El tamaño maximo se a excedido.')
			),
			'InvalidMime' => array(
				'message' => __d('meio_upload', 'tipo de archivo invalido.')
			),
			'InvalidExt' => array(
